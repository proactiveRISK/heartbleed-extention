...
//
// Heartbleed Tool is free software: you can redistribute it and/or modify it
...
// Heartbleed Tool.  If not, see <http://www.gnu.org/licenses/>.var EXPORTED_SYMBOLS=["HeartbleedCheckerBackgound"];
